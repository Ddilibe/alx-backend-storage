# alx-backend-storage
Repository containing all the lessons from ALX backend storage classes

## Some MYSQL commands that has to be remembered.
1. Browsing
```sql
SHOW DATABASES;
SHOW TABLES;
...
8. Repair Table after unclean shutdown
```sql
